    ...
    return [
        ...
        'demoData'    => [
            ...
            'demo-site-1' => [
                ...
                'previewImage' => get_template_directory_uri() . '/assets/demos/demo-blog/blog-screenshot.jpg',
                'previewUrl'   => 'https://wphuda.softmetik.com',
                'demoZip'      => get_template_directory_uri() . '/assets/demos/demo-blog/default-demo.zip',
                'blogSlug'     => 'blog',
                // 'settingsJson' => [
