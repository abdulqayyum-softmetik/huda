                            ...
                            <div class="w-100 d-xl-block d-lg-block d-md-none d-none">
                                <?php
                                    wp_nav_menu(array(
                                        ...
                                        'items_wrap' => '<ul id="%1$s" class="d-flex flex-wrap align-items-center justify-content-start gap-lg-3 gap-md-2 gap-3 %2$s">%3$s</ul>',
                                        'depth' => 2,
                    ...
                    <div class="col-lg-3 col-md-4 col-4 px-0">
                        <div class="d-flex align-items-center justify-content-end gap-3"> 
                            ...
                            <div class="d-xl-block d-lg-block d-md-block d-none">
                                <a href="<?php echo esc_url( $button_url ); ?>" target="_blank" rel="no-follow" class="buy-button">Subscribe</a>
                            </div>
